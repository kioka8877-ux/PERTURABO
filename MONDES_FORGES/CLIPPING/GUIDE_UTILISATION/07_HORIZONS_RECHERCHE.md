# 07_HORIZONS_RECHERCHE — Choisir la durée de recherche

## Principe

La durée demandée par le Champion définit le type d’opportunité recherché. Elle modifie les fenêtres de fraîcheur, les signaux prioritaires, la lecture de la tendance et le niveau de répétabilité attendu.
...
Le mode `7d` privilégie la stabilité, la demande persistante et la capacité à créer plusieurs angles. La fraîcheur immédiate pèse moins qu’en mode `6h`, tandis que la répétabilité, la diversité des chaînes et la non-cannibalisation deviennent plus importantes.

## Mode 30 jours

Le mode `30d` est destiné aux sujets récurrents, saisonniers ou evergreen. Il ne faut pas l’interpréter comme une simple fenêtre RSS de trente jours : il exige une demande régulière, une baseline comparable et un potentiel de série. Un pic isolé ne suffit pas.
...
Avant de valider un sujet, le Champion confirme :

- l’horizon demandé est bien celui de la campagne ;
- les preuves YouTube sont compatibles avec cet horizon ;
- la tendance n’est pas seulement un artefact d’une autre fenêtre ;
- le sujet peut être produit au rythme imposé ;
- la niche meme permet plusieurs angles distincts ;
- le sujet est sûr, non politique et non excessivement controversé ;
- les données manquantes sont connues avant la décision.
