...
def cmd_generate_logo(args):
    ...
    if sub_mode == "meme":
        ...
        mission = (
            ...
            "3 lignes) — VOIX D'UN ÉTUDIANT QUI THÉORISE SUR X : JAMAIS "
            "d'affirmation de faits (interdit : 'Doom destroyed the universe', "
            "statistiques posées comme vérités). C'est une théorie lancée comme "
            "un post étudiant : 'I have a theory guys...', 'What if...', "
            "'Okay hear me out...', 'Call me crazy but...'. Chaque angle = "
            "UNE théorie différente qui décline le meme_hook de l'angle + "
            ...
            "texte d'émotion du milieu, max 4 mots) — RÉACTION CENTRÉE "
            "ÉTUDIANTS : pour l'angle A01 = les étudiants DEVANT le tweet "
            "(ex: 'Students reading this', 'Students right now') ; pour les "
            "autres angles = la réaction du personnage/Doom face à la théorie "
            "(ex: 'Doom right now', 'Me watching this', 'Doom currently') "
            "selon l'émotion de l'angle. OBLIGATOIRE : chaque text_emotion "
            "se termine par ':' (ex: 'Students reading this:', 'Doom right "
            "now:'), 4) duration_sec (entier "
