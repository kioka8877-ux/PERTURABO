...
├── C01_SCOUT/                 ← CODEBASE/ + IN/ + OUT/ + TRACKING/
├── C02_TYRANT_CAMP/           ← CODEBASE/ + IN/ + OUT/ + TRACKING/
├── C03_SOURCE_HUNTER/         ← CODEBASE/ + IN/ + OUT/ + TRACKING/
├── C04_COPYWRITER/            ← CODEBASE/ + IN/ + OUT/ + TRACKING/
├── C05_PACKAGER/              ← CODEBASE/ + IN/ + OUT/ + TRACKING/
├── C06_TRACKER/               ← CODEBASE/ + IN/ + OUT/ + TRACKING/
...
|---|---|---|---|---|
| C01_SCOUT | ✅ | ✅ | ❌ | À implémenter par autre model |
| C02_TYRANT_CAMP | ✅ | ✅ | ❌ | À implémenter |
| C03_SOURCE_HUNTER | ✅ | ✅ | ❌ | À implémenter |
| C04_COPYWRITER | ✅ | ✅ | ❌ | Frégate lourde — pattern 4 phases distinct |
| C05_PACKAGER | ✅ | ✅ | ❌ | À implémenter |
| C06_TRACKER | ✅ | ✅ | ❌ | À implémenter |
...
| Porte 1 | C02_TYRANT_CAMP verdict campagne | Non démarré |
| Porte 2 | F02_ANGLESMITH N angles forgés | Non démarré |
| Porte 3 | C03 + C04 text_payloads prêts | Non démarré |
| Porte 4 | C05 production packs expédiés → OMNIS_WATCH | Non démarré |
