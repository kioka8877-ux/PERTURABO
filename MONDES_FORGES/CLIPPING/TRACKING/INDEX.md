...
|---|---|---|
| `C01_SCOUT` | `../C01_SCOUT/CODEBASE/TRACKING.md` | Chasse les assets campagne (jamais ailleurs) |
| `C02_TYRANT_CAMP` | `../C02_TYRANT_CAMP/CODEBASE/TRACKING.md` | Verdict campagne + océan bleu |
| `C03_SOURCE_HUNTER` | `../C03_SOURCE_HUNTER/CODEBASE/TRACKING.md` | Sélectionne vidéos longues à clipper |
| `C04_COPYWRITER` | `../C04_COPYWRITER/CODEBASE/TRACKING.md` | Frégate lourde — texte viral via premium direct |
| `C05_PACKAGER` | `../C05_PACKAGER/CODEBASE/TRACKING.md` | Emballe production packs |
| `C06_TRACKER` | `../C06_TRACKER/CODEBASE/TRACKING.md` | Checklist submission active + learnings |
