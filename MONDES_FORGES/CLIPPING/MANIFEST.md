...
|---|---|---|
| C01_SCOUT | `C01_SCOUT/CODEBASE/TRACKING.md` | ✅ rédigé |
| C02_TYRANT_CAMP | `C02_TYRANT_CAMP/CODEBASE/TRACKING.md` | ✅ rédigé |
| C03_SOURCE_HUNTER | `C03_SOURCE_HUNTER/CODEBASE/TRACKING.md` | ✅ rédigé |
| C04_COPYWRITER | `C04_COPYWRITER/CODEBASE/TRACKING.md` | ✅ rédigé (le plus détaillé — frégate lourde 4 phases) |
| C05_PACKAGER | `C05_PACKAGER/CODEBASE/TRACKING.md` | ✅ rédigé |
| C06_TRACKER | `C06_TRACKER/CODEBASE/TRACKING.md` | ✅ rédigé |
...
| `learnings/` | ✅ | ✅ `learnings.json` (squelette initial) | runtime (C06 nourrit) |
